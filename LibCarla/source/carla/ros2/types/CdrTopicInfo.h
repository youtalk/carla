...
///                         To compute the hash for a new type, generate the
///                         REP-2011 type-hash metadata with the rosidl
///                         tooling on a REP-2011-capable distro (e.g. build
///                         the message package in osrf/ros:jazzy-desktop and
///                         read share/<pkg>/msg/<Type>.json).
///
